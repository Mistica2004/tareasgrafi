Práctica: Tipos de Iluminación en OpenGL

Introducción

La iluminación es uno de los elementos más importantes en los gráficos por computadora, ya que permite simular la forma en que la luz interactúa con los objetos tridimensionales. Gracias a ella es posible generar sombras, reflejos y efectos visuales que aportan mayor realismo a una escena. En esta práctica se implementaron diferentes tipos de iluminación utilizando OpenGL para observar cómo afectan la apariencia de un modelo 3D.
...
Este programa crea una ventana gráfica utilizando GLFW, OpenGL y GLUT para representar un modelo tridimensional con forma de ojo compuesto por varias esferas. El objetivo principal es demostrar distintos tipos de iluminación disponibles en OpenGL.

El código incluye cinco modos de iluminación diferentes:

* Iluminación básica: utiliza una única fuente de luz blanca para iluminar el objeto.
* Iluminación múltiple: emplea varias fuentes de luz colocadas en distintas posiciones para generar diferentes efectos de sombreado.
* Iluminación direccional: simula una luz lejana, similar a la luz solar, cuyos rayos llegan en una misma dirección.
* Iluminación tipo Spotlight: genera un haz de luz concentrado en forma de cono, parecido al de una linterna o reflector.
* Iluminación de colores: utiliza varias luces de colores (rojo, verde y azul) para producir mezclas cromáticas sobre la superficie del modelo.

El usuario puede cambiar entre los distintos modos presionando las teclas del 0 al 4, permitiendo comparar visualmente los efectos de cada técnica de iluminación. Además, el modelo rota continuamente para observar cómo reaccionan las superficies ante las diferentes fuentes de luz.


Conclusión

La práctica permitió comprender el funcionamiento de diversos tipos de iluminación en OpenGL y su influencia en la apariencia de los objetos tridimensionales. Se observó cómo la posición, dirección, color e intensidad de las luces modifican la percepción de profundidad y volumen de una escena. Asimismo, se comprobó que el uso adecuado de la iluminación es fundamental para mejorar el realismo y la calidad visual de las aplicaciones gráficas en 3D.