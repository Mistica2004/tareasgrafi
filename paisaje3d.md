Paisaje Interactivo 3D

Introducción

Este proyecto consiste en el desarrollo de un entorno tridimensional interactivo utilizando Python, OpenGL, GLFW, OpenCV y MediaPipe. El objetivo principal es generar una escena 3D detallada que represente una pequeña ciudad y sus alrededores, incorporando diversos elementos como viviendas, escuela, hospital, iglesia, granja, estadio, carreteras, árboles, flores, animales y objetos animados.

Además de la representación gráfica, el sistema integra visión por computadora mediante MediaPipe para detectar la mano del usuario en tiempo real utilizando la cámara web. Gracias a esta detección, es posible controlar la navegación dentro del entorno virtual mediante movimientos de la mano, permitiendo desplazamientos, rotaciones y cambios de altura de la cámara.

El proyecto busca combinar gráficos computacionales, animación e interacción humano-computadora para crear una experiencia visual dinámica e inmersiva.
...
El programa inicia configurando una ventana gráfica mediante GLFW y OpenGL, donde se renderiza una escena tridimensional compuesta por múltiples objetos modelados a partir de primitivas geométricas como cubos, cilindros, pirámides y esferas.

La escena incluye diversos elementos:

* Terreno principal con carretera y aceras.
* Montañas y cielo con degradado de colores.
* Sol con efecto de brillo.
* Nubes y pájaros animados.
* Río y lago con efectos visuales de movimiento.
* Casas, escuela, hospital, iglesia, granja y edificios modernos.
* Estadio y torre de agua.
* Árboles, palmeras, flores y girasoles.
* Vehículos en movimiento sobre la carretera.
* Semáforos y farolas.
* Personas caminando.
* Animales como vacas, caballos, ovejas y perros.
* Globo aerostático animado.

Las animaciones son actualizadas continuamente mediante una función de actualización que modifica posiciones, ángulos y estados de los objetos para simular movimiento natural dentro del entorno.

Para la interacción, MediaPipe procesa las imágenes capturadas por la cámara web y detecta los puntos de referencia de la mano. Utilizando la posición del dedo índice y la distancia entre el pulgar y el índice, el sistema calcula la dirección de movimiento, rotación y altura de la cámara, permitiendo al usuario explorar la escena mediante gestos.

Finalmente, OpenGL renderiza todos los elementos en cada cuadro, generando una visualización tridimensional fluida e interactiva.

Conclusión

Se desarrolló exitosamente un entorno tridimensional interactivo utilizando técnicas de gráficos computacionales y visión por computadora. La implementación permitió crear una escena compleja con numerosos objetos, animaciones y efectos visuales que enriquecen la experiencia del usuario.

La integración de MediaPipe proporcionó una forma intuitiva de interacción mediante gestos de la mano, eliminando la necesidad de controles tradicionales y demostrando el potencial de las interfaces basadas en visión artificial.

Este proyecto permitió aplicar conocimientos relacionados con modelado 3D, animación, procesamiento de imágenes y programación gráfica, logrando una aplicación funcional que combina realismo visual e interacción en tiempo real.